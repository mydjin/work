...
import com.qihsoft.webdev.core.service.IMessageUserService;
import com.qihsoft.webdev.core.mapper.MessageUserMapper;
 ...
 */
@Service
public class MessageUserService extends TServiceImpl<MessageUserMapper, MessageUser> implements IMessageUserService {
   /**************************CURD begin******************************/ 
   // 创建
   @Override
   public MessageUser createMessageUser(MessageUser model) {
   ...
   // 删除
   @Override
   public Boolean deleteMessageUser(Object ids,String reviser) {
       return this.delete(ids,reviser);
   }
 
   // 修改
   @Override
   public MessageUser updateMessageUser(MessageUser model) {
   ...
   // 查询
   @Override
   public List<MessageUser> findByIds(Object ids) {
