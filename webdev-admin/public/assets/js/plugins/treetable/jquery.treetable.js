...
jQuery.TreeTable = function (tree_id, heads, tNodes) {
    if ($("#" + tree_id).length > 0) {
        ...
        for (var i = 0, l = newNodes.length; i < l; i++) {
            ...
            for (var j = 0; j < column_count - 1; j++) {
                var urlStr = "";
                /*if(j==2){
                    urlStr ="style=\"width:30%\"";
                }*/

                body_html += "<td " + urlStr + ">" + (node.td[j] ? node.td[j] : "") + "</td>";
            }
            body_html += "</tr>";
        }
        body_html += "</tbody>";
    ...
    jQuery.TreeTable = function (tree_id, heads, tNodes,widths) {
        if ($("#" + tree_id).length > 0) {
            var newNodes = [];
            var sort = function (s_pid) {
                for (var i = 0, l = tNodes.length; i < l; i++) {
            ...
            for (var i = 0; i < column_count; i++) {
                ...
                head_html += "<th style='width: "+widths[i]+";text-align: center'>" + heads[i] + "</th>";
            }
            head_html += "</tr></thead>";
            ...
            for (var i = 0, l = newNodes.length; i < l; i++) {
                ...
                body_html += "<tr style='"+style+"' data-tt-id='" + node.id + "' " + (node.pId ? "data-tt-parent-id='" + node.pId + "'" : "") + "><td class = 'td_left' style='width: "+widths[0]+"' ><span class='" + (node.isParent ? "parent" : "children") + "'>" + node.name + "</span></td>";
                for (var j = 0; j < column_count - 1; j++) {


                    body_html += "<td style='width: "+widths[j+1]+"'>" + (node.td[j] ? node.td[j] : "") + "</td>";
                }
                body_html += "</tr>";
            }
            body_html += "</tbody>";
