/**
 * Created by Taller on 2017/9/10.
 */
...
var toolModule = {
    ...
    getBranchListApi:toolV1+'/getBranchList',//获取党支部信息
    getNationListApi:toolV1 + '/getNationList',//获取民族信息
    getBranchCatalogueApi:toolV1+'/getBranchCatalogue',//获取学院党支部组织架构信息
...
var userModule = {
    ...
    getPersonBaseAndDetailApi: sysV1 + '/getPersonBaseAndDetail',
    getNationApi: baseV1 + '/nationInfo',
    updatePersonalBaseInfoApi: sysV1 + '/updatePersonalBaseInfo',
    updatePersonalDetailInfoApi: sysV1 + '/updatePersonalDetailInfo',
}
/*********************权限模块路由*************************/
var authModule = {
