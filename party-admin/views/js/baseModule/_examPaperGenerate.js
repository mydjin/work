...
var gapListData = [], multipleListData = [], singleListData = [], tFListData = [];
var gapListDataSelect = [], multipleListDataSelect = [], singleListDataSelect = [], tFListDataSelect = [];
var singleScore = 0, multipleScore = 0, gapScore = 0, trueFalseScore = 0;
...
var examPaperGenerate = {
    ...
    selectQuestion: function (event) {
        ...
        this.getQuestinList(questionType);

    },

    getQuestinList: function () {
    ...
    examInfo: function () {
        ...
        request.done(function (d) {
            ...
            if(isMakeStr!=null&&isMakeStr!=""){
                ...
                if(isMake==2){
                    tips.info("当前试卷已经组卷，重新组卷将会清空原来组卷信息！若确定要重新组卷请继续操作，若误点请关闭窗口！");
                }
            }
    ...
    queryQuestion: function () {
        ...
        examPaperGenerate.getQuestinList();
    },
...
var opt = {
    ...
    add: function () {
        ...
        if (data['type'] != 4 && typeof data['answerNumber'] == "undefined") {
        ...
        tips.confirm({
            message: '是否添加到该试卷？', fun: "opt.addConfirm();",
        ...
        for (var i = 0; i < selectIds.length; i++) {
            ...
            if (questionType == 1) {
                ...
                $('.true-false-question').eq($('.true-false-question').length - 1).after(
                    ...
                    + '<td style="text-align: center"><span class="glyphicon trueFalseQuestion glyphicon-minus" aria-hidden="true" >'
                ...
                $('.single-question').eq($('.single-question').length - 1).after(
                    ...
                    + '<td style="text-align: center"><span class="glyphicon singleQuestion glyphicon-minus" aria-hidden="true" >'
                ...
                $('.multiple-question').eq($('.multiple-question').length - 1).after(
                    ...
                    + '<td style="text-align: center"><span class="glyphicon multipleQuestion glyphicon-minus" aria-hidden="true" >'
                ...
                $('.gap-question').eq($('.gap-question').length - 1).after(
                    ...
                    + '<td style="text-align: center"><span class="glyphicon gapQuestion glyphicon-minus" aria-hidden="true" >'
