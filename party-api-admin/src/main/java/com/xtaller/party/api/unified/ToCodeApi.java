...
import com.xtaller.party.core.service.impl.SysAutoCodeService;
import com.xtaller.party.api.BaseApi;
import com.xtaller.party.utils.tool.PropertiesUtil;
...
public class ToCodeApi extends BaseApi {
    ...
    public Object createCode(@PathVariable("table") String table, @PathVariable("type") int type) throws IOException, SQLException {
        ...
        /***********************基础路径配置**************************/
        //实体包/路径
        String package_model = "com.xtaller.party.core.model";
        String path_model = "/model/";
        //新增的实体包/路径
        String package_doc_model = "com.xtaller.party.doc";

        //Mapper/路径
        String package_mapper = "com.xtaller.party.core.mapper";
        String path_mapper = "/mapper/";
        //IService
        String package_iservice = "com.xtaller.party.core.service";
        String path_iservice = "/service/";
        //Service
        String package_service = "com.xtaller.party.core.service.impl";
        String path_service = "/service/impl/";
        //Api
        String package_api = "com.xtaller.party.api.admin";
        String path_api = "/admin/";

        //项目路径
        String project = "/party-core/src/main/java/com/xtaller/party/core";
        //项目doc实体类路径
        String doc = "/party-api-admin/src/main/java/com/xtaller/party/doc/";
        //项目接口api路径
        String api = "/party-api-admin/src/main/java/com/xtaller/party/api/admin/";
        //项目根目录
        ...
        sb.append("import com.xtaller.party.utils.kit.IdKit;\n");
...
//            排除id和5个公有字段:id,creator,createTime,reviser,reviseTime,isDel
        ...
        sb.append("import java.util.List;\n");
        sb.append("import com.xtaller.party.utils.bean.Where;\n");
        sb.append("import " + package_model + "." + formatName(tableName) + ";\n\n");
        sb.append("/**\n");
        sb.append("* Created by Party on " + time + "\n");
        sb.append("*/\n");
        ...
        sb.append("import com.alibaba.fastjson.JSONObject;\n");
        sb.append("import com.xtaller.party.core.mapper." + formatName(tableName) + "Mapper;\n");
        sb.append("import com.xtaller.party.core.model." + formatName(tableName) + ";\n");
        sb.append("import com.xtaller.party.core.service.I" + formatName(tableName) + "Service;\n");
        sb.append("import com.xtaller.party.utils.base.TServiceImpl;\n");
        sb.append("import com.xtaller.party.utils.bean.Page;\n");
        sb.append("import com.xtaller.party.utils.convert.F;\n");
        sb.append("import org.springframework.stereotype.Service;\n\n");

        sb.append("import java.util.ArrayList;\n");
        sb.append("import java.util.List;\n");
        sb.append("import com.xtaller.party.utils.convert.W;\n");
        sb.append("import com.xtaller.party.utils.bean.Where;\n");
        sb.append("/**\n");
        sb.append(" * Created by Party on " + time + "\n");
        sb.append(" */\n");
        ...
        if (type != 2) {
            ...
            sb.append("import com.alibaba.fastjson.JSONObject;\n");
            sb.append("import com.xtaller.party.api.BaseApi;\n");
            sb.append("import com.xtaller.party.api.BaseApi;\n");
            sb.append("import com.xtaller.party.core.model." + formatName(tableName) + ";\n");
            sb.append("import com.xtaller.party.core.service.impl." + formatName(tableName) + "Service;\n");
            sb.append("import com.xtaller.party.doc." + formatName(tableName) + "Create;\n");
            sb.append("import com.xtaller.party.doc." + formatName(tableName) + "Update;\n");
            sb.append("import com.xtaller.party.utils.bean.Page;\n");
            sb.append("import com.xtaller.party.utils.convert.R;\n");
            sb.append("import com.xtaller.party.utils.convert.S;\n");
            sb.append("import com.xtaller.party.utils.convert.V;\n");
            sb.append("import com.xtaller.party.utils.convert.W;\n");
