...
public class TimeKit {
    ...
    */
    ...
    public static int getWeekStampLead(long beginTime,long endTime){
        int days = getDayStampLead(beginTime,endTime);
        int week = days/7+1;
        return week;
    }

    public static int getDayStampLead(long beginTime,long endTime){
        int days =  Math.abs((int)(( endTime -beginTime)/(24 * 60 * 60 )));
        return days;
    }
