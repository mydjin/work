...
import com.xtaller.party.core.mapper.SurveyRecordChatMapper;
import com.xtaller.party.core.model.SurveyRecordChat;
import com.xtaller.party.core.service.ISurveyRecordChatService;
 ...
 */
@Service
public class SurveyRecordChatService extends TServiceImpl<SurveyRecordChatMapper, SurveyRecordChat> implements ISurveyRecordChatService {
    /**************************CURD begin******************************/
    // 创建
    @Override
    public SurveyRecordChat createSurveyRecordChat(SurveyRecordChat model) {
    ...
    // 删除
    @Override
    public Boolean deleteSurveyRecordChat(Object ids, String reviser) {
        return this.delete(ids, reviser);
    }

    // 修改
    @Override
    public SurveyRecordChat updateSurveyRecordChat(SurveyRecordChat model) {
    ...
    // 查询
    @Override
    public List<SurveyRecordChat> findByIds(Object ids) {
    ...
    public List<JSONObject> queryById(String id) {
        List<JSONObject> list = baseMapper.queryById(id);
        return F.f2l(list, "id", "creator", "reverse");
    }

    public List<JSONObject> queryByNumber(String number) {
        List<JSONObject> list = baseMapper.queryByNumber(number);
        return F.f2l(list, "id", "creator", "reverse");
    }
