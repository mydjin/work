...
import com.xtaller.party.core.mapper.BranchMapper;
import com.xtaller.party.core.model.Branch;
import com.xtaller.party.core.service.IBranchService;
 ...
 */
@Service
public class BranchService extends TServiceImpl<BranchMapper, Branch> implements IBranchService {
    /**************************CURD begin******************************/
    // 创建
    @Override
    public Branch createBranch(Branch model) {
    ...
    // 删除
    @Override
    public Boolean deleteBranch(Object ids, String reviser) {
        return this.delete(ids, reviser);
    }

    // 修改
    @Override
    public Branch updateBranch(Branch model) {
    ...
    // 查询
    @Override
    public List<Branch> findByIds(Object ids) {
    ...
    //通过学院代码找学院所有的支部
    public List<JSONObject> getBranchByAcademyCode(String code) {
        List<JSONObject> list = baseMapper.queryByAcademy(code);
