...
import com.xtaller.party.core.mapper.VacateMapper;
import com.xtaller.party.core.model.Vacate;
import com.xtaller.party.core.service.IVacateService;
 ...
 */
@Service
public class VacateService extends TServiceImpl<VacateMapper, Vacate> implements IVacateService {
    /**************************CURD begin******************************/
    // 创建
    @Override
    public Vacate createVacate(Vacate model) {
    ...
    // 删除
    @Override
    public Boolean deleteVacate(Object ids, String reviser) {
        return this.delete(ids, reviser);
    }

    // 修改
    @Override
    public Vacate updateVacate(Vacate model) {
    ...
    // 查询
    @Override
    public List<Vacate> findByIds(Object ids) {
    ...
    public Page page(int index, int pageSize, String w) {
        ...
        return new Page(F.f2l(grades, "id", "scheduleId"), pageSize, totalCount, totalPage, currentPage);
    }
    ...
    public JSONObject queryById(String id) {
        JSONObject obj = baseMapper.getById(id);
        return F.f2j(obj, "id", "scheduleId");
    }
