...
import com.xtaller.party.core.mapper.MessageMapper;
import com.xtaller.party.core.model.Message;
import com.xtaller.party.core.service.IMessageService;
...
public class MessageService extends TServiceImpl<MessageMapper, Message> implements IMessageService {
    ...
    //批量插入
    public int sendMessages(List<Message> sendMessages) {
        String values = "";
