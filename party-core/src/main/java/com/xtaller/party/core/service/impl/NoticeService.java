...
import com.xtaller.party.core.mapper.NoticeMapper;
import com.xtaller.party.core.model.Notice;
import com.xtaller.party.core.service.INoticeService;
 ...
 */
@Service
public class NoticeService extends TServiceImpl<NoticeMapper, Notice> implements INoticeService {
    /**************************CURD begin******************************/
    // 创建
    @Override
    ...
    // 删除
    @Override
    public Boolean deleteNotice(Object ids, String reviser) {
        return this.delete(ids, reviser);
    }

    // 修改
    @Override
    public Notice updateNotice(Notice model) {
    ...
    // 查询
    @Override
    public List<Notice> findByIds(Object ids) {
    ...
    public List<JSONObject> queryDetails(String where) {
        List<JSONObject> list = baseMapper.queryDetail(where);
    ...
    //详情
    public List<JSONObject> queryDetail(String where) {
        List<JSONObject> list = baseMapper.queryDetail(where);
        return F.f2l(list, "id", "creator", "pictureId", "reverse");
    }
