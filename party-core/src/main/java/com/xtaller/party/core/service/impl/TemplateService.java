...
import com.xtaller.party.core.mapper.TemplateMapper;
import com.xtaller.party.core.model.Template;
import com.xtaller.party.core.service.ITemplateService;
 ...
 */
@Service
public class TemplateService extends TServiceImpl<TemplateMapper, Template> implements ITemplateService {
    /**************************CURD begin******************************/
    // 创建
    @Override
    public Template createTemplate(Template model) {
    ...
    // 删除
    @Override
    public Boolean deleteTemplate(Object ids, String reviser) {
        return this.delete(ids, reviser);
    }

    // 修改
    @Override
    public Template updateTemplate(Template model) {
    ...
    // 查询
    @Override
    public List<Template> findByIds(Object ids) {
