...
import com.xtaller.party.core.mapper.ArticleTypeMapper;
import com.xtaller.party.core.model.ArticleType;
import com.xtaller.party.core.service.IArticleTypeService;
 ...
 */
@Service
public class ArticleTypeService extends TServiceImpl<ArticleTypeMapper, ArticleType> implements IArticleTypeService {
    /**************************CURD begin******************************/
    // 创建
    @Override
    public ArticleType createArticleType(ArticleType model) {
    ...
    // 删除
    @Override
    public Boolean deleteArticleType(Object ids, String reviser) {
        return this.delete(ids, reviser);
    }

    // 修改
    @Override
    public ArticleType updateArticleType(ArticleType model) {
    ...
    // 查询
    @Override
    public List<ArticleType> findByIds(Object ids) {
