...
//        }
    ...
    public JSONObject importUser(JSONObject object) {
        ...
        if (V.isEmpty(this.findByUserName(object.getString("number")))) {
            ...
            if (model == null) {
                ...
                Boolean detailExist = userDetailInfoService.exist(W.f(
                        W.and("number", "eq",object.getString("number")),
                        W.and("isDel", "eq", "0"))
                );
                if(detailExist){
                ...
                userDetailInfo.setNumber(object.getString("number"));
                if (object.getString("academyCode") != null) {
                    userDetailInfo.setAcademyCode(object.getString("academyCode"));
                }
                if (object.getString("departCode") != null) {
                    userDetailInfo.setDepartCode(object.getString("departCode"));
                }
                if (object.getString("myClass") != null) {
                    userDetailInfo.setMyClass(object.getString("myClass"));
                }
                userDetailInfo.setCreator(object.getString("userid"));
    ...
    public Object findByLoginName(String loginName) {
        ...
        if (!V.isEmpty(infos)) {
            ...
            u.put("info", info);
            u.put("name",info.getString("name"));
        }
