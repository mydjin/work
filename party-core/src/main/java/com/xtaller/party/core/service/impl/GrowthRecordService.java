...
import com.xtaller.party.core.mapper.GrowthRecordMapper;
import com.xtaller.party.core.model.GrowthRecord;
import com.xtaller.party.core.service.IGrowthRecordService;
 ...
 */
@Service
public class GrowthRecordService extends TServiceImpl<GrowthRecordMapper, GrowthRecord> implements IGrowthRecordService {
    /**************************CURD begin******************************/
    // 创建
    @Override
    public GrowthRecord createGrowthRecord(GrowthRecord model) {
    ...
    // 删除
    @Override
    public Boolean deleteGrowthRecord(Object ids, String reviser) {
        return this.delete(ids, reviser);
    }

    // 修改
    @Override
    public GrowthRecord updateGrowthRecord(GrowthRecord model) {
    ...
    // 查询
    @Override
    public List<GrowthRecord> findByIds(Object ids) {
