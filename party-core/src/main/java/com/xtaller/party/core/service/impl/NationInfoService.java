...
import com.xtaller.party.core.mapper.NationInfoMapper;
import com.xtaller.party.core.model.NationInfo;
import com.xtaller.party.core.service.INationInfoService;
 ...
 */
@Service
public class NationInfoService extends TServiceImpl<NationInfoMapper, NationInfo> implements INationInfoService {
    /**************************CURD begin******************************/
    // 创建
    @Override
    public NationInfo createNationInfo(NationInfo model) {
    ...
    // 删除
    @Override
    public Boolean deleteNationInfo(Object ids, String reviser) {
        return this.delete(ids, reviser);
    }

    // 修改
    @Override
    public NationInfo updateNationInfo(NationInfo model) {
    ...
    // 查询
    @Override
    public List<NationInfo> findByIds(Object ids) {
