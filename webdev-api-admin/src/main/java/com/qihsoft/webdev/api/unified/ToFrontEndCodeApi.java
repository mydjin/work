...
import com.qihsoft.webdev.doc.FrontEndCode;
...
//        ResultSet rs = getTableCol(tableName);
        ...
        //html
        String html = "/qihsoft-admin/views/test/form/";
        ...
        //js路径
        String js = "/qihsoft-admin/views/test/js/";
        ...
        //ejs路径
        String ejs = "/qihsoft-admin/test/ejs/";
    ...
    private StringBuffer htmlGenerate(String htmlPath, String tableName) throws SQLException, IOException {
        ...
        while (rs.next()) {
            ...
            //longtext类型判断：富文本
                ...
                htmlCode.append("                              placeholder=\"请输入" + COLUMN_COMMENT + "\"></textarea>\n");
            ...
            //其他普通字段：input
                ...
                if (iter.hasNext()) {
                    for (int i = 0; iter.hasNext(); i++) {
                        ...
                        //渲染select
                        if (i == 0) {
                            htmlCode.append("                    <select required name=\"" + COLUMN_name + "\" id=\"" + COLUMN_name + "\"  class=\"form-control\"> \n");
                        }
                    ...
                    htmlCode.append("                    <input required type=\"text\" name=\"" + COLUMN_name + "\" maxlength=\"20\" class=\"form-control\"\n");
                    htmlCode.append("                           placeholder=\"请输入" + COLUMN_COMMENT + "\">\n");
                }
            }
            ...
            htmlCode.append("                </td>\n");
            htmlCode.append("                <td class=\"form-item-remark\"></td>\n");
            htmlCode.append("            </tr>\n");
    ...
    private StringBuffer jsGenerate(String jsPath, String tableName) throws SQLException, IOException {
        ...
        while (rs.next()) {
            ...
            if (COLUMN_name.endsWith("Time") && "int(11)".equals(COLUMN_TYPE)) {
                ...
                editorCode.append("         $('#" + COLUMN_name + "').summernote('code', model['" + COLUMN_name + "']);\n");
            }
        }
    ...
    private ResultSet getTableCol(String tableName) {
        ...
        try {
            ...
            PreparedStatement pstm = conn.prepareStatement(
                    "select COLUMN_name,data_type,COLUMN_COMMENT,COLUMN_TYPE " +
