...
import com.qihsoft.webdev.core.service.impl.SysAutoCodeService;
...
public class ToCodeApi extends BaseApi {
    ...
    public Object createCode(@PathVariable("table") String table) throws IOException, SQLException {
        ...
        /***********************基础路径配置**************************/
        //实体包/路径
        String package_model = "com.qihsoft.webdev.core.model";
        String path_model = "/model/";
        //新增的实体包/路径
        String package_doc_model = "com.qihsoft.webdev.doc";

        //Mapper/路径
        String package_mapper = "com.qihsoft.webdev.core.mapper";
        String path_mapper = "/mapper/";
        //IService
        String package_iservice = "com.qihsoft.webdev.core.service";
        String path_iservice = "/service/";
        //Service
        String package_service = "com.qihsoft.webdev.core.service.impl";
        String path_service = "/service/impl/";
        //Api
        String package_api = "com.qihsoft.webdev.api.admin";
        String path_api = "/admin/";

        //项目路径
        String project = "/qihsoft-core/src/main/java/com/qihsoft/core";
        //项目doc实体类路径
        String doc = "/qihsoft-api-admin/src/main/java/com/qihsoft/doc/";
        //项目接口api路径
        String api = "/qihsoft-api-admin/src/main/java/com/qihsoft/api/admin/";
        //项目根目录
        ...
        sb.append("import IdKit;\n");
        sb.append("import java.io.Serializable;\n\n");
        sb.append("/**\n");
        sb.append(" * Created by Qihsoft on " + time + "\n");
        sb.append(" */\n");
...
//                    timeStr.append("            \",FROM_UNIXTIME(attendanceTime,'%Y-%m-%d') attendanceTimeStr  \" +\n");
//                }
//            }
//        }
        sb.append("    @Select(\"SELECT a.* \" + \n");
...
//            排除id和5个公有字段:id,creator,createTime,reviser,reviseTime,isDel
        ...
        sb.append("            \"JOIN (SELECT id from " + tableName + " where isDel = 0 ${where} \" + \n");
        sb.append("            \"LIMIT #{index}, #{size})b ON a.id=b.id order by a.createTime asc \") \n");
        ...
        sb.append("import com.alibaba.fastjson.JSONObject;\n");
        sb.append("import com.qihsoft.webdev.core.mapper." + formatName(tableName) + "Mapper;\n");
        sb.append("import com.qihsoft.webdev.core.model." + formatName(tableName) + ";\n");
        sb.append("import com.qihsoft.webdev.core.service.I" + formatName(tableName) + "Service;\n");
        sb.append("import TServiceImpl;\n");
        sb.append("import Page;\n");
        sb.append("import F;\n");
        ...
        sb.append("import com.qihsoft.webdev.core.model." + formatName(tableName) + ";\n");
        sb.append("import com.qihsoft.webdev.core.service.impl." + formatName(tableName) + "Service;\n");
        sb.append("import com.qihsoft.webdev.doc." + formatName(tableName) + "Create;\n");
        sb.append("import com.qihsoft.webdev.doc." + formatName(tableName) + "Update;\n");
        sb.append("import Page;\n");
        sb.append("import R;\n");
        sb.append("import S;\n");
        sb.append("import V;\n");
        ...
        sb.append("        //        W.and(\"idCard\",\"eq\",model.getIdCard()),\n");
        sb.append("        //        W.and(\"isDel\",\"eq\",\"0\"))\n");
        sb.append("        //);\n");
        sb.append("        //if(exist)\n");
        sb.append("        //    return R.error(\"身份证号已经存在请更换一个身份证号\");\n\n");
        ...
        sb.append("}\n");
        System.out.println("path-api: " + apiPath + formatName(tableName) + "Api.java");
